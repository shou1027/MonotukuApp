...
(function() {
  document.addEventListener("DOMContentLoaded", function() {
    var post_image, post_image_file;
    ...
    if (post_image_file) {
      document.getElementById("post-image-select").onclick = function() {
        return post_image_file.click();
      };
      return post_image_file.onchange = function(e) {
        var files;
        files = e.target.files;
        if (files.length === 1) {
          return post_image.src = window.URL.createObjectURL(files[0]);
        }
      };
    }
  });
...
(function() {
  document.addEventListener("DOMContentLoaded", function() {
    var user_image, user_image_file;
    ...
    if (user_image_file) {
      document.getElementById("user-image-select").onclick = function() {
        return user_image_file.click();
      };
      return user_image_file.onchange = function(e) {
        var files;
        files = e.target.files;
        if (files.length === 1) {
          return user_image.src = window.URL.createObjectURL(files[0]);
        }
      };
    }
  });
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  document.onclick = function(){
    if(header_dropdown && (document.documentElement.clientWidth <= 800)){
    ...
    if(dropdown && (document.documentElement.clientWidth <= 860)){
